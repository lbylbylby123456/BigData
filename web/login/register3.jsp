...
<body>
	...
	<div id="head"></div>
	<div id="middle">
		<form action="register3.action" method="post">
			<ul style="text-align: center;">
				<li style="font-size: 48px">房&nbsp;东&nbsp;注&nbsp;册</li>
