...
<div id="middle">
    <form action="login2.action" method="post">
        <ul style="text-align: center;">
            <li class="font-weight-bold" style="font-size: 56px;font-weight: 700">后台管理登录</li>

            <li><input class="name" name="username_g" placeholder="请输入用户名" style="width:330px;margin-top: 25px;"></li>
            <li><input type="password" name="password_g" class="pwd"placeholder="请输入密码" style="width:330px;"></li>
            ...
            <li></li>
            <li><span>
					<a href="register1.jsp" style="color: cornsilk;font-size: larger;font-weight: bold">注册</a>&nbsp; &nbsp;|&nbsp; &nbsp;
