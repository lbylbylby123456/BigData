	...
	<div id="middle">
		<form action="login1.action" method="post">
			<ul style="text-align: center;">
				<%--<li class="font-weight-bold" style="font-size: 56px;font-weight: 700">Start Your Journey</li>--%>
					<img src="../../assets/index/img/journey-light-text-240.png">
				<li><input class="name" name="username" placeholder="请输入用户名" style="width:330px;margin-top: 25px;"></li>
				<li><input type="password" name="password" class="pwd"placeholder="请输入密码" style="width:330px;"></li>
				...
				<li></li>
				<li><span>
					<a href="register.jsp" style="color: cornsilk;font-size: larger;font-weight: bold">注册</a>&nbsp; &nbsp;|&nbsp; &nbsp;
					<a href="login2.jsp" style="color:cornsilk;font-size: larger;font-weight: bold">管理员登录</a>&nbsp; &nbsp;|&nbsp; &nbsp;
					<a href="login3.jsp" style="color:cornsilk;font-size: larger;font-weight: bold">房东登录</a>
				</span></li>
			</ul>
		</form>
	</div>
